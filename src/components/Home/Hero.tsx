    ...
    <section className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-4 -left-4 bg-white text-primary-600 p-3 sm:p-4 rounded-xl shadow-lg"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -right-4 bg-accent-500 text-white p-3 sm:p-4 rounded-xl shadow-lg"
            >
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg
          ...
          // className="relative block w-full h-10 sm:h-16 fill-white"
          className="relative block w-full h-10 sm:h-16 fill-white rotate-180"
        >
